...
typedef struct {
  ...
  uint8_t report_TMC_registers_for_controller;  // to enable TMC registers reporting in status string.
  uint8_t report_TMC_status_for_controller;     // to enable TMC status reporting in status string.  
  #endif
