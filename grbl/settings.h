...
#define EEPROM_ADDR_TMC_CALIBRATION_X   1792U //TMC calibration 0x700 // Calibration for Trinamics drivers. 128 16-bit entries for 5 drivers + temperatures + crcs. 1280+10+3bytes
#define EEPROM_ADDR_TMC_CALIBRATION_Y   (EEPROM_ADDR_TMC_CALIBRATION_X + (TMC_SG_PROFILE_POINTS + 1) * 2 * 2 + 1)
#define EEPROM_ADDR_TMC_CALIBRATION_Z   (EEPROM_ADDR_TMC_CALIBRATION_Y + (TMC_SG_PROFILE_POINTS + 1) * 2 * 2 + 1)
#define EEPROM_ADDR_STATISTICS          3088U //statistics      0xC10
#define EEPROM_ADDR_STACK_DUMP          3338U //stack dump      0xD0A
#define EEPROM_ADDR_SERIAL              3904U //serial number   0xF40
