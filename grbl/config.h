...
#define CMD_TMC_HEX '^'   //BK Mod allow control of the TMC motor controllers while bypassing serial buffer
...
#define REPORT_OVR_REFRESH_BUSY_COUNT 21  // (1-255)
#define REPORT_OVR_REFRESH_IDLE_COUNT 11  // (1-255) Must be less than or equal to the busy count
#define REPORT_WCO_REFRESH_BUSY_COUNT 31  // (2-255)
...
// #define HOMING_AXIS_SEARCH_SCALAR  10.5 // Uncomment to override defaults in limits.c.
// #define HOMING_AXIS_LOCATE_SCALAR  100.0 // Uncomment to override defaults in limits.c.
...
#define PARKING_TARGET -19.0 // Parking axis target. In mm, as machine coordinate [-max_travel,0].
...
#define PARKING_PULLOUT_INCREMENT 6.0 // Spindle pull-out and plunge distance in mm. Incremental distance.
